...
const FourProject = ({ setDownloadLink, setReceivedFiles }) => {
    ...
    const handleFormSubmit = async (values, onSubmitProps) => {
        ...
        const projects = [{
            ...
            projectName: values.projectNameThree, 
            picture: values.pictureThree,
            picturePath: values.pictureThree.name,
            description: values.descriptionThree,
            liveLink: values.liveLinkThree,
            githubLink: values.githubLinkThree
        },{
            projectName: values.projectNameFour, 
            picture: values.pictureFour,
            picturePath: values.pictureFour.name,
            description: values.descriptionFour,
            liveLink: values.liveLinkFour,
            githubLink: values.githubLinkFour
        },]
